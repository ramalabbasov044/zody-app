...
const Header = () => {
    ...
    useEffect(() => {
        if(asPath.split("/")[1] !== "Product"){
            push(`?LNG=${i18n.language}`)
        } 
    },[i18n.language])

    
    console.log(`/${asPath.split("/")[1].slice(0,7)}`, Routes.Product);
    ...
    return (
        <div style={{marginBottom: '80px'}}>
            <header className={`${styles.Wrapper}`}>
                <div className={`${isScroll ? styles.bgActive : styles.noActive} `}>
                            ...
                            <div className={styles.NavbarBody}>
                                <div className={styles.Navbar}>
                                    <li className={styles.List}>
                                        <a onClick={() => push(Routes.Features)} style={{fontFamily: i18n.language == "ru" ? "Montserrat" : "Poppins"}} className={`${styles.Item} ${activeLink(Routes.Features, `/${asPath.split("/")[1].slice(0,8)}`) ? styles.active : ""}`}>
                                            {
                                                t('features')
                                            }
                                        </a>
                                    ...
                                    <li className={styles.List}>
                                        <a onClick={() => push(Routes.Help)} style={{fontFamily: i18n.language == "ru" ? "Montserrat" : "Poppins"}}  className={`${styles.Item} ${activeLink(Routes.Help, `/${asPath.split("/")[1].slice(0,4)}`) ? styles.active : ""}`}>
                                            {
                                                t('helpCenter')
                                            }
                                        </a>
                                    ...
                                    <li className={styles.List}>
                                        <a onClick={() => push(Routes.Blog)} style={{fontFamily: i18n.language == "ru" ? "Montserrat" : "Poppins"}}  className={`${styles.Item} ${activeLink(Routes.Blog, `/${asPath.split("/")[1].slice(0,4)}`) || "Product" == `${asPath.split("/")[1].slice(0,8)}` ? styles.active : ""}`}>
                                            {
                                                t('blog')
                                            }
                                        </a>
                                    ...
                                    <li className={styles.List}>
                                        <a onClick={() => push(Routes.Contact)} style={{fontFamily: i18n.language == "ru" ? "Montserrat" : "Poppins"}}  className={`${styles.Item} ${activeLink(Routes.Contact, `/${asPath.split("/")[1].slice(0,7)}`) ? styles.active : ""}`}>
                                            {
                                                t('contact')
                                            }
                                        </a>
